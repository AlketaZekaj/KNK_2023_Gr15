...
public class StudentController implements Initializable {
    ...
    ObservableList<String> profesori  = FXCollections.observableArrayList("Dalina Vranovci", "Valon Raca", "Blend Arifaj","Sevdie Alshiqi","Qamil Kabashi");
    ObservableList<String> lenda  = FXCollections.observableArrayList("Programim ne Internet", "Arkitektura e Kompjutereve", "Komunikimi Njeri-Kompjuter","Menaxhim i Projekteve","Elektronike");
