...
public class EditAppointmentController implements Initializable {
    Connection conn;
    Consultations konsult = new Consultations();
    ...
    public void oldAppointment(Consultations selected){
        this.konsult.setProfesori(selected.getProfesori());
        this.konsult.setData(selected.getData());
    }
